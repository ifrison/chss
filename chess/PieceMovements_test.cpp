...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	board.At(chss::Position{.y = 4, .x = 5}) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
...
TEST(PieceMovements, PawnWhite_Forward_BlockedByOtherPiece) {
	...
	auto board = chss::kEmptyBoard;
		board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
		board.At(chss::Position{.y = 4, .x = 5}) = chss::Piece{chss::Type::Pawn, otherPieceColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
		constexpr auto expectedResult = std::array<chss::Position, 0>{};
		EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
	}
...
TEST(PieceMovements, PawnBlack_Forward) {
	constexpr auto pawn_position = chss::Position{.y = 3, .x = 5};
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	board.At(chss::Position{.y = 2, .x = 5}) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
	constexpr auto expectedResult = std::array<chss::Position, 0>{};
	EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
}
...
TEST(PieceMovements, PawnBlack_Forward_BlockedByOtherPiece) {
	...
	auto board = chss::kEmptyBoard;
		board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
		board.At(chss::Position{.y = 2, .x = 5}) = chss::Piece{chss::Type::Pawn, otherPieceColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
		constexpr auto expectedResult = std::array<chss::Position, 0>{};
		EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
	}
...
TEST(PieceMovements, PawnWhite_DoubleForward_BlockedLongByOtherPiece) {
	...
	auto board = chss::kEmptyBoard;
		board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
		board.At(chss::Position{.y = 3, .x = 5}) = chss::Piece{chss::Type::Pawn, otherPieceColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
		constexpr auto expectedResult = std::array{chss::Position{.y = 2, .x = 5}};
		EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
	}
...
TEST(PieceMovements, PawnBlack_DoubleForward_BlockedShortByOtherPiece) {
	...
	auto board = chss::kEmptyBoard;
		board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
		board.At(chss::Position{.y = 5, .x = 5}) = chss::Piece{chss::Type::Pawn, otherPieceColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
		constexpr auto expectedResult = std::array<chss::Position, 0>{};
		EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
	}
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	board.At(chss::Position{.y = 4, .x = 4}) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	board.At(chss::Position{.y = 4, .x = 1}) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	board.At(chss::Position{.y = 2, .x = 4}) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	board.At(chss::Position{.y = 2, .x = 6}) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
	constexpr auto expectedResult =
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	board.At(chss::Position{.y = 2, .x = 1}) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	board.At(chss::Position{.y = 3, .x = 4}) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
	constexpr auto expectedResult = std::array{chss::Position{.y = 2, .x = 5}, chss::Position{.y = 3, .x = 5}};
	EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
}
...
auto board = chss::kEmptyBoard;
	board.At(pawn_position) = chss::Piece{chss::Type::Pawn, chss::Color::Black};
	board.At(chss::Position{.y = 4, .x = 4}) = chss::Piece{chss::Type::Pawn, chss::Color::White};
	const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesPawn(board, pawn_position));
	constexpr auto expectedResult = std::array{chss::Position{.y = 5, .x = 5}, chss::Position{.y = 4, .x = 5}};
	EXPECT_THAT(result, testing::UnorderedElementsAreArray(expectedResult));
}
...
TEST(PieceMovements, Knight_Move) {
	...
	auto board = chss::kEmptyBoard;
		board.At(knight_position) = chss::Piece{chss::Type::Knight, knight_color};
		const auto result =
...
TEST(PieceMovements, Knight_Move_BlockedByPiceOfSameColor) {
	for (const auto playerColor : {chss::Color::White, chss::Color::Black}) {
		constexpr auto knight_position = chss::Position{.y = 3, .x = 5};
	auto board = chss::kEmptyBoard;
		board.At(knight_position) = chss::Piece{chss::Type::Knight, playerColor};
		board.At(chss::Position{.y = 1, .x = 4}) = chss::Piece{chss::Type::Pawn, playerColor};
		board.At(chss::Position{.y = 2, .x = 7}) = chss::Piece{chss::Type::Knight, playerColor};
		board.At(chss::Position{.y = 4, .x = 3}) = chss::Piece{chss::Type::Queen, playerColor};
		board.At(chss::Position{.y = 5, .x = 4}) = chss::Piece{chss::Type::King, playerColor};
		const auto result =
			to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesKnight(board, knight_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 1, .x = 6},
...
TEST(PieceMovements, Knight_Capture) {
	...
	auto board = chss::kEmptyBoard;
		board.At(knight_position) = chss::Piece{chss::Type::Knight, playerColor};
		board.At(chss::Position{.y = 1, .x = 4}) = chss::Piece{chss::Type::Pawn, enemyColor};
		board.At(chss::Position{.y = 2, .x = 7}) = chss::Piece{chss::Type::Knight, enemyColor};
		board.At(chss::Position{.y = 4, .x = 3}) = chss::Piece{chss::Type::Queen, enemyColor};
		board.At(chss::Position{.y = 5, .x = 4}) = chss::Piece{chss::Type::King, enemyColor};
		const auto result =
			to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesKnight(board, knight_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 1, .x = 4},
...
TEST(PieceMovements, Bishop_Move) {
	...
	auto board = chss::kEmptyBoard;
		board.At(bishop_position) = chss::Piece{chss::Type::Bishop, bishop_color};
		const auto result =
...
TEST(PieceMovements, Bishop_Move_BlockedByPieceOfSameColor) {
	for (const auto playerColor : {chss::Color::White, chss::Color::Black}) {
		constexpr auto bishop_position = chss::Position{.y = 3, .x = 5};
	auto board = chss::kEmptyBoard;
		board.At(bishop_position) = chss::Piece{chss::Type::Bishop, playerColor};
		board.At(chss::Position{.y = 1, .x = 3}) = chss::Piece{chss::Type::Pawn, playerColor};
		board.At(chss::Position{.y = 6, .x = 2}) = chss::Piece{chss::Type::Bishop, playerColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::King, playerColor};
		const auto result =
			to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesBishop(board, bishop_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
...
TEST(PieceMovements, Bishop_Capture) {
	...
	auto board = chss::kEmptyBoard;
		board.At(bishop_position) = chss::Piece{chss::Type::Bishop, playerColor};
		board.At(chss::Position{.y = 1, .x = 3}) = chss::Piece{chss::Type::Knight, enemyColor};
		board.At(chss::Position{.y = 6, .x = 2}) = chss::Piece{chss::Type::Bishop, enemyColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Pawn, enemyColor};
		const auto result =
			to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesBishop(board, bishop_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
...
TEST(PieceMovements, Rook_Move) {
	...
	auto board = chss::kEmptyBoard;
		board.At(rook_position) = chss::Piece{chss::Type::Rook, rook_color};
...
TEST(PieceMovements, Rook_Move_BlockedByPieceOfSameColor) {
	for (const auto playerColor : {chss::Color::White, chss::Color::Black}) {
		constexpr auto rook_position = chss::Position{.y = 3, .x = 5};
	auto board = chss::kEmptyBoard;
		board.At(rook_position) = chss::Piece{chss::Type::Rook, playerColor};
		board.At(chss::Position{.y = 1, .x = 5}) = chss::Piece{chss::Type::Pawn, playerColor};
		board.At(chss::Position{.y = 6, .x = 5}) = chss::Piece{chss::Type::Knight, playerColor};
		board.At(chss::Position{.y = 3, .x = 1}) = chss::Piece{chss::Type::Rook, playerColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::King, playerColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesRook(board, rook_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 5},
			chss::Position{.y = 4, .x = 5},
...
TEST(PieceMovements, Rook_Capture) {
	...
	auto board = chss::kEmptyBoard;
		board.At(rook_position) = chss::Piece{chss::Type::Rook, playerColor};
		board.At(chss::Position{.y = 1, .x = 5}) = chss::Piece{chss::Type::Pawn, enemyColor};
		board.At(chss::Position{.y = 6, .x = 5}) = chss::Piece{chss::Type::Knight, enemyColor};
		board.At(chss::Position{.y = 3, .x = 1}) = chss::Piece{chss::Type::Rook, enemyColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::King, enemyColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesRook(board, rook_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 5},
			chss::Position{.y = 1, .x = 5},
...
TEST(PieceMovements, Queen_Move) {
	...
	auto board = chss::kEmptyBoard;
		board.At(queen_position) = chss::Piece{chss::Type::Queen, queen_color};
...
TEST(PieceMovements, Quen_Move_BlockedByPieceOfSameColor) {
	for (const auto playerColor : {chss::Color::White, chss::Color::Black}) {
		constexpr auto queen_position = chss::Position{.y = 3, .x = 5};
	auto board = chss::kEmptyBoard;
		board.At(queen_position) = chss::Piece{chss::Type::Queen, playerColor};
		board.At(chss::Position{.y = 1, .x = 3}) = chss::Piece{chss::Type::Pawn, playerColor};
		board.At(chss::Position{.y = 6, .x = 2}) = chss::Piece{chss::Type::Knight, playerColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Bishop, playerColor};
		board.At(chss::Position{.y = 1, .x = 5}) = chss::Piece{chss::Type::Rook, playerColor};
		board.At(chss::Position{.y = 6, .x = 5}) = chss::Piece{chss::Type::Queen, playerColor};
		board.At(chss::Position{.y = 3, .x = 1}) = chss::Piece{chss::Type::King, playerColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::Pawn, playerColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesQueen(board, queen_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
			chss::Position{.y = 2, .x = 6},
...
TEST(PieceMovements, Queen_Capture) {
	...
	auto board = chss::kEmptyBoard;
		board.At(queen_position) = chss::Piece{chss::Type::Queen, playerColor};
		board.At(chss::Position{.y = 1, .x = 3}) = chss::Piece{chss::Type::Pawn, enemyColor};
		board.At(chss::Position{.y = 6, .x = 2}) = chss::Piece{chss::Type::Knight, enemyColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Bishop, enemyColor};
		board.At(chss::Position{.y = 1, .x = 5}) = chss::Piece{chss::Type::Rook, enemyColor};
		board.At(chss::Position{.y = 6, .x = 5}) = chss::Piece{chss::Type::Queen, enemyColor};
		board.At(chss::Position{.y = 3, .x = 1}) = chss::Piece{chss::Type::King, enemyColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::Pawn, enemyColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesQueen(board, queen_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
			chss::Position{.y = 1, .x = 3},
...
TEST(PieceMovements, King_Move) {
	...
	auto board = chss::kEmptyBoard;
		board.At(king_position) = chss::Piece{chss::Type::King, king_color};
...
TEST(PieceMovements, King_Move_BlockedByPieceOfSameColor) {
	for (const auto playerColor : {chss::Color::White, chss::Color::Black}) {
		constexpr auto king_position = chss::Position{.y = 3, .x = 5};
	auto board = chss::kEmptyBoard;
		board.At(king_position) = chss::Piece{chss::Type::King, playerColor};
		board.At(chss::Position{.y = 2, .x = 5}) = chss::Piece{chss::Type::Pawn, playerColor};
		board.At(chss::Position{.y = 3, .x = 4}) = chss::Piece{chss::Type::Bishop, playerColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::Rook, playerColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Queen, playerColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesKing(board, king_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
			chss::Position{.y = 2, .x = 6},
...
TEST(PieceMovements, King_Capture) {
	...
	auto board = chss::kEmptyBoard;
		board.At(king_position) = chss::Piece{chss::Type::King, playerColor};
		board.At(chss::Position{.y = 2, .x = 5}) = chss::Piece{chss::Type::Pawn, enemyColor};
		board.At(chss::Position{.y = 3, .x = 4}) = chss::Piece{chss::Type::Bishop, enemyColor};
		board.At(chss::Position{.y = 3, .x = 6}) = chss::Piece{chss::Type::Rook, enemyColor};
		board.At(chss::Position{.y = 4, .x = 6}) = chss::Piece{chss::Type::Queen, enemyColor};
		const auto result = to_vector<chss::Position>(chss::MoveGeneration::PseudoLegalMovesKing(board, king_position));
		constexpr auto expectedResult = std::array{
			chss::Position{.y = 2, .x = 4},
			chss::Position{.y = 2, .x = 5},
